...
extension UIStoryboard {
    //a function to return a viewcontroller by the UIStoryBoard key
    class func viewController(identifier: String) -> UIViewController {
        return UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: identifier)
    }
}

//an extension to fill a UIImage with an image from url
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    public lazy var propertyDetailViewController: PropertyDetailViewController = {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Properti_Anda")
